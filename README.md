...
A standard AI skill and Claude Code slash command for comprehensive project pre-analysis before implementation.
...
ProGraph 是一个标准 AI Skill，同时保留 Claude Code slash command 版本。它会在你开始写代码之前，从 4 个维度对项目进行全面分析：
